...
class TestInfoRoute(unittest.TestCase):
    ...
    def test_v1_info_invalid_auth(self):
        invalid_header = {"Authorization": ""}
        response = self.app.get("info", headers=invalid_header)
    ...
    def test_v1_info(self, *args):
        response = self.app.get("info", headers=self.header)
