...
class TestIntentSentenceSuggestionRoute(unittest.TestCase):
    ...
    def test_v2_invalid_authorization(self):
        ...
        response = self.app.post(
            "v2/intent_sentence_suggestion", headers=invalid_header
        )
    ...
    def test_v2_invalid_intent(self):
        ...
        response = self.app.post(
            "v2/intent_sentence_suggestion", headers=self.header, json=invalid_body
        )
        self.assertEqual(422, response.status_code)
    ...
    @patch(
        ...
        return_value={"intent": "text", "suggested_sentences": []},
    )
    def test_v2_intent_sentence_suggestion(self, *args):
        body = {"intent": "test", "language": "en"}
        response = self.app.post(
            "v2/intent_sentence_suggestion", headers=self.header, json=body
        )
